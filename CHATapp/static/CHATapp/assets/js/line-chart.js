    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#0b76b6',
                data: [5, 4, 8, 7, 7, 6, 5, 5, 4, 3, 8, 5, 4, 7, 6],
            }]
        },
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#F0B41A',
                data: [1.8, 4.1, 8.6, 4.9, 2.0, 6.5, 6.4, 5.0, 4.9, 3.0, 4.5, 2.5, 5.9, 6.8, 1.0],
            }]
        },
        // Configuration options go here
        options: {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#fd9d24',
                fill: true,
                data: [1.8, 4.1, 5.0, 4.9, 2.0, 6.5, 5.0, 8.6, 2.0, 3.0, 4.5, 2.5, 2.5, 3.5, 1.0],
            }]
        },
        // Configuration options go here
        options: {
...
if ($('#coin_sales4').length) {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "Salinity",
                backgroundColor: "rgba(32, 234, 58, 0.1)",
                borderColor: '#fd9d44',
                fill: true,
                data: [1.8, 4.1, 5.0, 4.9, 2.0, 6.5, 5.0, 8.6, 2.0, 3.0, 4.5, 2.5, 2.5, 3.5, 1.0],
            }]
...
if ($('#coin_sales5').length) {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "Temp.",
                backgroundColor: "rgba(47, 63, 158, 0.1)",
                borderColor: '#fd9d24',
                fill: true,
                data: [18, 14.1, 15.0, 14.9, 20, 16.5, 15.0, 18.6, 12.0, 13.0, 14.5, 12.5, 12.5, 13.5, 11.0],
            }]
        },
        // Configuration options go here
        options: {
...
if ($('#verview-shart').length) {
    var myConfig = {
        ...
        "plot": { "aspect": "spline" },
        "series": [{
                "values": [5, 4, 8, 7, 7, 6, 5, 5, 4, 3, 8, 5, 4, 7, 6],
                "line-color": "#F0B41A",
                /* "dotted" | "dashed" */
            ...
            {
                "values": [1.1, 4.8, 8.6, 5, 2.0, 7.5, 6.4, 5.0, 5.9, 3.0, 4.5, 2.5, 7.9, 6.8, 1.0],
                "line-color": "#0884D9",
                /* "dotted" | "dashed" */
                "line-width": 5 /* in pixels */ ,
                "marker": { /* Marker object */
            ...
            {
                "values": [1.8, 4.1, 5.0, 4.9, 2.0, 6.5, 5.0, 8.6, 2.0, 3.0, 4.5, 2.5, 2.5, 3.5, 1.0],
                "line-color": "#ff471a",
                /* "dotted" | "dashed" */
                "line-width": 5 /* in pixels */ ,
                "marker": { /* Marker object */
            ...
            {
                "values": [2.8, 5.1, 6.0, 4.9, 3.0, 7.5, 5.0, 8.6, 2.0, 3.0, 6.5, 2.5, 4.5, 3.5, 1.0],
                "line-color": "#ff66ff",
                /* "dotted" | "dashed" */
                "line-width": 5 /* in pixels */ ,
                "marker": { /* Marker object */
            ...
            {
                "values": [18, 14.1, 15.0, 14.9, 20, 16.5, 15.0, 18.6, 12.0, 13.0, 14.5, 12.5, 12.5, 13.5, 11.0],
                "line-color": "#66ff33",
                /* "dotted" | "dashed" */
                "line-width": 5 /* in pixels */ ,
                "marker": { /* Marker object */
